...
def get_model_and_processor(model_id,device):
...
def create_trainer(model_to_train, training_config, train_dataset, peft_config, processor):
...
def main(): 
    ...
    train_annotation_file = f'{VLM_ANN_DIR}/{data_name}_annotations_train.json'
    ...
    trainer = create_trainer(model_to_train, training_config, train_dataset, peft_config, processor)
    trainer.train()
